      ...
      <div className="bg-gray-800 shadow-xl shadow-pink-800 rounded-xl w-11/12 md:w-2/5 h-7/12 p-6">
        <div className="flex flex-col">
          ...
          <div className="flex items-center justify-center rounded-xl mt-5">
            <div className="shrink-0 rounded-xl overflow-hidden h-36 md:h-64 md:w-64 ">
              <img
          ...
          <div className="flex flex-col justify-start rounded-xl mt-5">
            ...
            <p className="text-gray-400 text-sm my-1">
              Joined Funding Campaign for:{" "}
              <span className="font-semibold">{nft?.campaignName}</span>
            </p>
            ...
            <div className="flex justify-between items-center space-x-2 mt-4">
              <div className="flex justify-start items-center">
                <Identicon
                  string={nft?.owner}
                  size={50}
                  className="bg-white h-10 w-10 object-contain rounded-full mr-3"
                />
